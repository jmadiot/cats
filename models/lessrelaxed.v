...
(* Translation of model Less Relaxed ARM llh model *)
...
Definition cc0 := dd ⊔ (ctrl ⊔ (addrpo ⊔ (WW po_loc ⊔ (RW po_loc ⊔ (rdw ⊔ detour))))).
...
(* End of translation of model Less Relaxed ARM llh model *)
