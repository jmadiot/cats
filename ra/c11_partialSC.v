...
Definition r1 := hb.
Definition r2 := (fsb ⊔ 1) ⋅ (mo_0 ⋅ (sbf ⊔ 1)).
Definition r3 := rf° ⋅ (toid SC ⋅ mo_0).
Definition r4 := rf° ⋅ (hbl ⋅ toid W).
Definition r5 := fsb ⋅ fr_0.
Definition r6 := fr_0 ⋅ sbf.
Definition r7 := fsb ⋅ (fr_0 ⋅ sbf).
Definition scp := r1 ⊔ (r2 ⊔ (r3 ⊔ (r4 ⊔ (r5 ⊔ (r6 ⊔ r7))))).
Definition Spartial := acyclic (cartesian SC SC ⊓ scp ⊓ !id).
